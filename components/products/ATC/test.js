...
export default class SingleProductVariations extends React.Component {
  ...
  findImageWithColor = (color) => {
    const variations = this.variations.filter((variation) => {
      return (
        variation.attributes.filter((attribute) => attribute.option == color)
          .length > 0
      );
    });
                        ...
                        <div
                          ...
                          {option.key == 'Color' && (
                            <div
                              style={
                                isDisable()
                                  ? styles.colorAttributeDisable
                                  : isSelected()
                                  ? styles.colorAttributeSelected
                                  : styles.colorAttributeEnable
                              }
                              onClick={(e) => {
                              ...
                              <img
                                src={this.findImageWithColor(option.value)}
                                style={{
                                  width: '100%',
                                  height: '100%',
                                  objectFit: 'cover',
